...
function ThemeToggle() {
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggleTheme}
      className="w-10 h-10 rounded-full bg-white/10 dark:bg-slate-800/50 backdrop-blur-sm hover:bg-white/20 dark:hover:bg-slate-700/50 transition-all duration-300 hover:scale-110"
    >
      {isDark ? (
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-colors duration-300">
        {/* Navigation */}
        <nav className="fixed top-0 w-full z-50 backdrop-blur-md bg-white/80 dark:bg-slate-900/80 border-b border-white/20 dark:border-slate-700/50 transition-colors duration-300">
          ...
          <div className="text-center z-10 px-6 max-w-5xl mx-auto">
            ...
            <div className="space-y-6 mb-12">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-tight">
                <span className="block text-slate-800 dark:text-white mb-2 transition-colors duration-300">Hi, I&rsquo;m</span>
        ...
        <section id="about" className="py-32 px-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm relative overflow-hidden transition-colors duration-300">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-20">
              ...
              <h2 className="text-5xl md:text-6xl font-bold text-slate-800 dark:text-white mb-6 leading-tight transition-colors duration-300">
                Crafting Digital
                <span className="block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                  Experiences
                </span>
            ...
            <div className="grid lg:grid-cols-3 gap-20 items-center mb-20">
              <div className="space-y-8">
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-3 transition-colors duration-300">My Journey</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-3 transition-colors duration-300">My Expertise</h3>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed transition-colors duration-300">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-3 transition-colors duration-300">My Philosophy</h3>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed transition-colors duration-300">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {achievements.map((achievement, index) => (
                <Card key={index} className="text-center p-8 bg-gradient-to-br from-white/80 to-white/40 dark:from-slate-800/80 dark:to-slate-800/40 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group">
                  ...
                  <div className="text-3xl font-bold text-slate-800 dark:text-white mb-2 transition-colors duration-300">
                    {achievement.number}
                  </div>
                  <div className="text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1 transition-colors duration-300">
                    {achievement.label}
                  </div>
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 dark:text-white mb-6 transition-colors duration-300">Skills & Expertise</h2>
              ...
              {skills.map((skill) => (
                ...
                >
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <h3 className="font-semibold text-slate-800 dark:text-white transition-colors duration-300">{skill.name}</h3>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-slate-600 dark:text-slate-300 transition-colors duration-300">Proficiency</span>
                        <span className="text-slate-800 dark:text-white font-medium transition-colors duration-300">{skill.level}%</span>
                      </div>
        ...
        {/* Projects Section */}
        <section id="projects" className="py-24 px-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm transition-colors duration-300">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 dark:text-white mb-6 transition-colors duration-300">Featured Projects</h2>
              <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6"></div>
                  ...
                  >
                    ...
                    <CardHeader className="pb-4">
                      <div className="flex justify-between items-start mb-2">
                        <CardTitle className="text-xl text-slate-800 dark:text-white transition-colors duration-300">{project.title}</CardTitle>
        ...
        <section id="contact" className="py-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-800 dark:text-white mb-6 transition-colors duration-300">Let&rsquo;s Work Together</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <Card className="p-8 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                ...
                <h3 className="text-lg font-semibold text-slate-800 dark:text-white mb-2 transition-colors duration-300">Email</h3>
                <p className="text-slate-600 dark:text-slate-300 transition-colors duration-300">oussemabenyahia89@gmail.com</p>
              </Card>
              <Card className="p-8 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Phone className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-lg font-semibold text-slate-800 dark:text-white mb-2 transition-colors duration-300">Phone</h3>
              ...
              <Card className="p-8 bg-gradient-to-br from-cyan-50 to-blue-100 dark:from-cyan-900/20 dark:to-blue-900/20 border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                ...
                <p className="text-slate-600 dark:text-slate-300 transition-colors duration-300">Tunis, Tunisia</p>
              </Card>
            </div>
          </div>
        </section>
