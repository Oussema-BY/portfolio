  ...
  const projects = [
    {
      ...
      description:
        "Corporate website for L'Escalier Consulting with a modern design, integrated admin dashboard.",
      image: "/escalier.jpg",
      technologies: [
        "Next.js",
        "React",
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-colors duration-300">
          ...
          <div className="text-center z-10 px-6 max-w-5xl mx-auto">
            ...
            <div className="space-y-6 mb-12">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-tight">
                <span className="block text-slate-800 dark:text-white mb-2 transition-colors duration-300">
                  Hi, I&rsquo;m
                </span>
              ...
              <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed transition-colors duration-300">
                Software Engineering Student – Evening Program & Full-Stack
                Developer crafting exceptional digital experiences with modern
                technologies
              </p>
            </div>
            ...
            <div className="flex justify-center space-x-6">
              ...
              >
                <Link
                  href="https://www.linkedin.com/in/oussema-ben-yahia/"
                  target="_blank"
                >
        ...
        <section
          id="about"
          className="py-32 px-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm relative overflow-hidden transition-colors duration-300"
        >
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed transition-colors duration-300">
                ...
                difference in people&rsquo;s lives
              </p>
            </div>
            <div className="grid lg:grid-cols-3 gap-20 items-center mb-20">
              <div className="space-y-8">
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-3 transition-colors duration-300">
                        My Journey
                      </h3>
                      <p className="text-slate-600 dark:text-slate-300 leading-relaxed transition-colors duration-300">
                        I&rsquo;m a software engineering student with hands-on
                        experience building modern web applications through
                        academic and personal projects.
                        <br />
                        My passion for technology drives me to continuously
                        learn and adapt to new challenges in the ever-evolving
                        tech landscape.
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed transition-colors duration-300">
                    ...
                    Supabase, with a focus on delivering clean, efficient code
                    and intuitive user experiences.
                    <br />
                    Every project is an opportunity to solve real-world problems
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed transition-colors duration-300">
                    I believe great software comes from understanding user needs
                    and translating them into elegant, functional solutions.
                    <br />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {achievements.map((achievement, index) => (
                <Card
                  key={index}
                  className="text-center p-8 bg-gradient-to-br from-white/80 to-white/40 dark:from-slate-800/80 dark:to-slate-800/40 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group"
                >
              ...
              {skills.map((skill) => (
                ...
                >
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <h3 className="font-semibold text-slate-800 dark:text-white transition-colors duration-300">
                        {skill.name}
                      </h3>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-slate-800 dark:text-white font-medium transition-colors duration-300">
                          {skill.level}%
                        </span>
                      </div>
        ...
        <section
          id="projects"
          className="py-24 px-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm transition-colors duration-300"
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 dark:text-white mb-6 transition-colors duration-300">
        ...
        <footer className="py-12 px-6 bg-slate-900 dark:bg-slate-950">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="border-t border-slate-800 mt-8 pt-8 text-center">
              <p className="text-slate-400">
                © 2025 Oussema Ben Yahia. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
